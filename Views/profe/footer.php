...
<!-- &copy;   -->
    2023 Creado por estudiantes de
    <a href="#" class="text-white" data-bs-toggle="modal" data-bs-target="#creatorsModal">
        ISFT Angaco
    </a>
</footer>
<!---------- Creators Modal ----------->
        ...
        <div class="modal-content">
            <div class="modal-header">                
                <h5 class="modal-title" id="creatorsModalLabel">
                    Creado por estudiantes de ISFT Angaco <i class="fas fa-user pr-2" title="Lucero,Olmos,Perez"></i>
                </h5>
