    ...
    try {
        ...
        if ($count > 0) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: alumno_index.php?mensaje=" . urlencode("Persona ingresada con éxito."));
                exit();
            } else {
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="fecha_ingreso" value="<?php echo htmlspecialchars($fecha_ingreso); ?>" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                <!-- --------------------------------- -->
