                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="correlativas.php?id=<?php echo htmlspecialchars($materia['id_materia'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-success"><i class="fa-sharp fa-solid fa-folder-open"></i></a>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                        ...
                                        <td class="text-center"><a href="materia_alumno.php?id=<?php echo htmlspecialchars($materia['id_materia'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-success">Listado de Alumnos</a></td>
                                    </tr>
                            <?php
                                }
                            } catch (PDOException $e) {
