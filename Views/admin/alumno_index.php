        ...
        <div class="col-sm">
            <div class="card rounded-2 border-0">
                <div class="card-header pb-0 bg-dark text-white ">
                    ...
                    <a class="btn btn-warning float-right mb-2 mr-2" href="nota_materia.php">Calificaciones por Materias</a>
                </div>
                <!-- -------------------- -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <!-- <a href="nota_una.php?id=<?php echo $alumno['id_persona']; ?>" class="btn btn-warning btn-sm" type="button">Nota</a> -->
                                                </div>
                                            </td>
