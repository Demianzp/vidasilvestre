...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['id'])) {
        ...
        $consulta_actualizar->bindParam(':ciclo', $ciclo, PDO::PARAM_STR);
                        ...
                        <form method="post" class="form" action="">
                            ...
                            <option value="" >tipo</option>
                             ...
                             <label for="ciclo">Año:</label>
                                <select name="ciclo" id="ciclo" class="form-control" autocomplete="off" value="<?php echo htmlspecialchars($materia['ciclo']); ?>" maxlength="10">
                            ...
                            <div class="mt-3 mb-2">
                                ...
                                <a class="btn btn-warning" href="listadomateria.php">Ver Listado</a>
                            </div>
